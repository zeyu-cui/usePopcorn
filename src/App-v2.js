  ...
  return (
    <>
      ...
      <Main>
        ...
        <Box>
          {
            selectedId ? (<MovieDetail selectedId={selectedId} onCloseMovie={handleCloseMovie} onAddWatched={handleAddWatched} watched={watched} />) : (
              <>
        ...
        <><header>
          ...
          <section>
            <div className="rating">
              {!isWatched.length ? <> <StarRating maxRating={10} size={24} onSetRating={setUserRating} />
